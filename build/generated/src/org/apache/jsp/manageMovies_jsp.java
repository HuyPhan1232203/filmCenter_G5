...
public final class manageMovies_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("        <form id=\"addMovieForm\" action=\"DispatchServlet\">\r\n");
      ...
      out.write("                <input name=\"btAction\" type=\"submit\" value=\"Add Movie\"/>\r\n");
      out.write("        </form>\r\n");
      ...
      out.write("\r\n");
      out.write("                    <td>\r\n");
      out.write("                        <form action=\"DispatchServlet\" method=\"POST\" style=\"display:inline;\">\r\n");
      out.write("                            <input type=\"hidden\" name=\"movieID\" value=\"");
      out.print( moviedto.getMovieID());
      out.write("\">\r\n");
      out.write("                            <input type=\"hidden\" name=\"btAction\" value=\"Delete\">\r\n");
      ...
      out.write("\r\n");
      out.write("                    <td>\r\n");
      out.write("                        <form id=\"updateMovieForm\" action=\"UpdateMovieServlet\" method=\"POST\">\r\n");
      out.write("                            <input type=\"hidden\" name=\"movieID\" value=\"");
      out.print( moviedto.getMovieID());
      out.write("\"> <!-- Hidden ID field -->\r\n");
      out.write("\r\n");
      out.write("                            <label for=\"movieTitle\">Title:</label>\r\n");
      out.write("                            <input name=\"movieTitle\" type=\"text\" id=\"movieTitle\" value=\"");
      out.print( moviedto.getMovieTitle());
      out.write("\" required>\r\n");
      out.write("\r\n");
      out.write("                            <label for=\"movieName\">Name:</label>\r\n");
      out.write("                            <input name=\"movieName\" type=\"text\" id=\"movieName\" value=\"");
      out.print( moviedto.getMovieName());
      out.write("\" required>\r\n");
      out.write("\r\n");
      out.write("                            <label for=\"movieGenre\">Genre:</label>\r\n");
      out.write("                            <input name=\"movieGenre\" type=\"text\" id=\"movieGenre\" value=\"");
      out.print( moviedto.getMovieGenre());
      out.write("\" required>\r\n");
      out.write("\r\n");
      out.write("                            <label for=\"movieDuration\">Duration (mins):</label>\r\n");
      out.write("                            <input name=\"movieDuration\" type=\"number\" id=\"movieDuration\" value=\"");
      out.print( moviedto.getMovieDuration());
      out.write("\" min=\"0\" required>\r\n");
      out.write("\r\n");
      out.write("                            <label for=\"movieDescription\">Description:</label>\r\n");
      out.write("                            <textarea name=\"movieSynopsis\" id=\"movieDescription\" rows=\"3\">");
      out.print( moviedto.getMovieSynopsis());
      out.write("</textarea>\r\n");
      out.write("\r\n");
      out.write("                            <label for=\"movieImage\">Poster:</label>\r\n");
      out.write("                            <input name=\"movieImage\" type=\"text\" id=\"movieImage\" value=\"");
      out.print( moviedto.getMovieImage());
      out.write("\" required>\r\n");
      out.write("\r\n");
      out.write("                            <input name=\"btAction\" type=\"submit\" value=\"Update Movie\"/>\r\n");
      out.write("                        </form>\r\n");
      out.write("                    </td>\r\n");
      out.write("\r\n");
      out.write("                </tr>\r\n");
      ...
      out.write("\r\n");
      out.write("                <tr>\r\n");
      out.write("                    <td colspan=\"6\">No movies available</td>\r\n");
      out.write("                </tr>\r\n");
      out.write("                ");
 }
      out.write("\r\n");
